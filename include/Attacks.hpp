...
struct DefinedAttacks {
    ...
    static DefinedAttacks get(const Attacks attack) {
        switch (attack) {
            case ATTACK1:
                return DefinedAttacks{Attack("ATTACK1", 10, 0.42, 0.05, 0.42)};
            case ATTACK2:
                return DefinedAttacks{Attack("ATTACK2", 20, 1.5, 0.2, 0.4)};
            case ATTACK3:
                return DefinedAttacks{Attack("ATTACK3", 30, 5.0, 0.4, 1.0)};
            case ATTACK4:
                return DefinedAttacks{Attack("ATTACK4", 40, 2.0, 0.3, 0.6)};
            case ATTACK5:
                return DefinedAttacks{Attack("ATTACK5", 50, 5.0, 0.6, 1.5)};
